export const CLIENTE_FINANCEIRO_MARKDOWN = `
# Financeiro
...
Ao clicar no **ícone de olho**, uma modal se abre, mostrando informações detalhadas sobre a fatura.
...
export const CLIENTE_FINANCEIRO_ACTIONS = {
  previous: {
    title: "",
    url: ""
  },
